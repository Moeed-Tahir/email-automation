...
const SignupFlow = () => {
        ...
        return (
          ...
          >
            <div className="w-full max-w-3xl space-y-8 text-start">
              ...
              <button
                className="w-8/9 md:w-full lg:w-full mx-auto flex items-center justify-center bg-[rgba(44,81,76,1)] text-white border-2 border-[rgba(44,81,76,1)] py-3 px-6 rounded-lg hover:bg-transparent hover:text-[rgba(44,81,76,1)] transition-colors"
                onClick={nextStep}
              >
                <svg
                  className="w-5 h-5 mr-2"
          ...
          >
            <div className="w-full max-w-3xl space-y-8 text-start">
              ...
              <div className="w-full space-y-6 flex flex-col items-start justify-start sm:mr-24">
                ...
                <Button
                  onClick={nextStep}
                  className="w-full bg-[rgba(44,81,76,1)] border-2 border-[rgba(44,81,76,0.9)] hover:bg-transparent hover:text-[rgba(44,81,76,1)] h-12 text-base sm:text-lg"
                >
                  <svg
                    className="size-5 mr-1"
                    fill="currentColor"
            ...
            <div className="w-full max-w-3xl space-y-8 text-start">
              ...
              <div className="flex justify-between w-full gap-4">
                <Button
                  variant="outline"
                  onClick={prevStep}
                  className="h-12 w-32 md:w-36 text-base sm:text-lg border-gray-300 text-gray-700"
                >
                  Back
                </Button>
                <Button
                  onClick={nextStep}
                  className="h-12 w-32 md:w-44 text-base sm:text-lg bg-[#2c514c] text-white border-2 border-[rgba(44,81,76,1)] hover:bg-transparent hover:text-[rgba(44,81,76,1)]"
                >
                  Next
                </Button>
              </div>
              ...
              <div className="md:space-y-12 border border-gray-200 rounded-sm p-4 sm:p-6 bg-white">
                ...
                <div className="flex justify-between">
                  <Button
                    variant="outline"
                    onClick={prevStep}
                    className="h-12 w-32 md:w-36 text-base sm:text-lg px-6 sm:px-8 border-gray-300 text-gray-700"
                  >
                    Back
                  </Button>
                  <Button
  ...
  return (
    // <div className="flex flex-col md:flex-row h-screen bg-[rgb(255,253,240)] overflow-hidden">
    //   {/* Image Section - Hidden on mobile */}
    //   <motion.div
    //     key={`image-${currentStep}`}
    //     className="w-full  hidden lg:flex  items-center justify-center p-4 max-h-screen"
    //   >
    //     <img
    //       src={getImageForStep()}
    //       alt={`Step ${currentStep}`}
    //       className="max-w-full h-screen object-contain shrink-0"
    //     />
    //   </motion.div>

    //   {/* Content Section */}
    //   <div className="w-full lg:w-[70%] relative h-full overflow-y-auto">
    //     <AnimatePresence custom={direction} initial={false}>
    //       {renderStep()}
    //     </AnimatePresence>
    //   </div>
  ...
  {/* Image Section - Only visible on lg and up */}
  <motion.div
    key={`image-${currentStep}`}
  ...
  {/* Logo Section - Only visible on sm and md */}
  <div className="w-full flex lg:hidden items-center justify-center p-5">
    <img
      src="/email-logo.jpg" // replace with your logo path
      alt="Logo"
      className="max-w-full object-contain shrink-0"
    />
  </div>
