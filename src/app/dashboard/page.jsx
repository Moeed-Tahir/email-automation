    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 w-full">
          <div className="grid auto-rows-min gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-6">
            <div className="bg-white col-span-2 flex items-center justify-between rounded-md shadow-md lg:hover:scale-102 p-2">
            ...
            <div className="bg-white rounded-xl p-5 flex flex-col items-start justify-center gap-5 border-b-3 border-[#2C514C] lg:hover:scale-105 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            ...
            <div className="bg-white rounded-xl p-5 flex flex-col items-start justify-center gap-5 border-b-3 border-[#EA5455]/50 lg:hover:scale-105 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-xl p-5 flex flex-col items-start justify-center gap-5 border-b-3 border-[#00CFE8] lg:hover:scale-105 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-xl p-5 flex flex-col items-start justify-center gap-5 border-b-3 border-[#FF9F43] lg:hover:scale-105 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              <div className="flex items-center gap-4">
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(
                  (num) => (
                    <Button
                      ...
                      className={
                        num === currentPage
                          ? "bg-[#2C514C] text-white cursor-pointer"
                          : "bg-gray-200 text-[#2C514C] hover:bg-[#2C514C] hover:text-white cursor-pointer"
                      }
